...
public interface ILocationRepository
{
    ...
    Task<IReadOnlyCollection<Location>> GetBySegmentIdsAsync(List<Guid> segmentIds, CancellationToken ct = default);
    ...
    Task<bool> UpdateSegmentIdAsync(Guid locationId, Guid newSegmentId, CancellationToken ct = default);
