...
public record CancelPaymentWithContextReq(PaymentGatewayEnum PaymentGateway, string PaymentId, string PayerId, string Token, string PaymentIntentId, string ClientSecret, string SessionId, string OrderCode, string Signature, Guid TransactionId);
